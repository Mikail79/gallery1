            ...
            <div class="card shadow-sm" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                      ...
                      <div class="komen">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#comment{{ $foto->id }}">({{ count($foto->komentarFoto)  }}) Komentar</button>
                        <div class="modal fade" id="comment{{ $foto->id }}" tabindex="-1" aria-labelledby="comment{{ $foto->id }}Label" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h1 class="modal-title text-center fs-5" id="comment{{ $foto->id }}Label">{{ $foto->title }}</h1>
                                    ...
                                    <div class="my-3">
                                        ...
                                        <div class="card p-3 overflow-auto" style="max-height: 180px">
                                            ...
                                            @foreach ($foto->komentarFoto as $komentar)
                                                <div class="d-flex flex-column card m-2 px-2 pt-1">
